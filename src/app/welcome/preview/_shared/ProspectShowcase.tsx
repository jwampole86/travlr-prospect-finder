...
export default function ProspectShowcase() {
  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 bg-muted/40 rounded-lg px-3 py-2">
        <Search size={13} className="text-muted-foreground shrink-0" />
        <span className="min-w-0 flex-1 text-xs text-muted-foreground truncate">Search by address, city, or owner name…</span>
          ...
          {visibleLeads.map((lead) => (
            <div key={lead.id} className="p-3 space-y-2">
              <div className="flex items-start justify-between gap-2">
                ...
                <div className="w-20 shrink-0"><ProspectScoreBar score={lead.prospectScore} /></div>
              </div>
